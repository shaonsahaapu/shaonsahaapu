...
<!-- Profile-details card: its "Contributions" total + year graph include private
     contributions (the green-graph setting is on), so it reflects real activity.
     The other summary cards need repo access (public only) and are omitted.
